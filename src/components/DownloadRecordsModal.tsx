...
export default function DownloadRecordsModal({
  ...
  const [selectedLevel, setSelectedLevel] = useState<'Semua' | 'SMP' | 'SMA'>('Semua');
  ...
  const handleGeneratePDF = async () => {
    ...
    try {
      ...
      doc.text(`Dicetak: ${nowStr}`, 196, currentY, { align: 'right' });
      doc.text(`Divisi Kurikulum Akademik`, 196, currentY + 4, { align: 'right' });
      ...
      autoTable(doc, {
        ...
        columnStyles: {
          ...
          4: { halign: 'center', cellWidth: 12, textColor: [30, 30, 30] }, // Neutral dark
          5: { halign: 'center', cellWidth: 12, textColor: [30, 30, 30] }, 
          6: { halign: 'center', cellWidth: 12, textColor: [30, 30, 30] }, 
          7: { halign: 'center', cellWidth: 12, textColor: [30, 30, 30] }, 
